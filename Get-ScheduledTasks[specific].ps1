...
Where-Object -FilterScript {$_.TaskName -like "\[taskDirName]]*"} | Export-Csv D:\Development\PowerShell\_outputs\ScheduledJobsExport_$remoteComputer'_'$(get-date -f yyyyMMdd).csv