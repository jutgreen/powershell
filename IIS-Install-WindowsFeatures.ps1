<#
.SYNOPSIS
   Installs Windows Features if not already installed.
.DESCRIPTION
   Checks if the requested Windows Feature is already installed or not, if not then installed the requested Windows Feature. 
...
AddFeatureIfMissing "Web-Net-Ext"
AddFeatureIfMissing "Web-Net-Ext45"
AddFeatureIfMissing "Web-Asp-Net"
...
AddFeatureIfMissing "NET-HTTP-Activation"
AddFeatureIfMissing "Web-Scripting-Tools"
AddFeatureIfMissing "Web-Includes"
AddFeatureIfMissing "Web-Http-Redirect"